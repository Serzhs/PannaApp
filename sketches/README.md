...
| `Featured.dc.html` | Featured tab: recipes we wrote, searchable |
| `You.dc.html` | You tab: avatar, name, settings |
...
| `ReadRecipe.dc.html` | Read a recipe, with Add to my recipes on a featured or shared one |
...
Seventeen drawings. Three tabs &mdash; Recipes, Featured, You &mdash; with everything else stacking
...
`ReadRecipe` and `WriteRecipe` are drawn taller than the others because they show the
